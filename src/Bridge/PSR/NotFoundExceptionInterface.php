<?php
    /**
     * Project Name:    Wingman Synapse - Bridge - PSR - Not Found Exception Interface
    ...
    if (interface_exists('Psr\Container\NotFoundExceptionInterface')) {
        /**
         * PSR-11 compatibility bridge for not-found service resolution exceptions.
         *
         * When psr/container is installed this interface extends
         * Psr\Container\NotFoundExceptionInterface, so implementations can satisfy
